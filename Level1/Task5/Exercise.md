...
c. Set the permissions of the /usr/src/web.txt file to 0744.


d. Ensure the user/group owner of the /usr/src/web.txt file is tony on app server 1, steve on app server 2 and banner on app server 3.
